        ...
        <div class="col-md-12">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="bg-secondary bg-opacity-25 container"><?= $user->udaje->meno . ' ' . $user->udaje->priezvisko ?></div>
                </div>
                <div class="col-md-4">
                    <h6>Titul:</h6>
                    <div class="bg-secondary bg-opacity-25 container"><?= $user->udaje->titul ?: '-' ?></div>
                </div>
                <div class="col-md-4">
                    <h6>Adresa:</h6>
                    <div class="bg-secondary bg-opacity-25 container"><?= $user->udaje->adresa ?></div>
                </div>
            </div>
        </div>
    </div>
